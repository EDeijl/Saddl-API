...
var courier1 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Henk', picture: 'http://placehold.it/350x350', status: 'Beschikbaar',location: {longitude:51.9172745 , latitude: 4.484275}, _specialties: [specialty1._id, specialty2._id]});

var courier2 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Harry', picture: 'http://placehold.it/350x350'});
var courier3 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Harrold', picture: 'http://placehold.it/350x350'});
var courier4 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Henk', picture: 'http://placehold.it/350x350'});
...
var order1 = new Order({origin: 'Rotterdam', destination: 'Spijkenisse', _packages: [package1._id, package2._id, package3._id], _courier: courier1});
var order2 = new Order({origin: 'Rotterdam', destination: 'Spijkenisse', _packages: [package1._id, package2._id, package3._id], _courier: courier2});
var order3 = new Order({origin: 'Rotterdam', destination: 'Spijkenisse', _packages: [package1._id, package2._id, package3._id], _courier: courier3});
