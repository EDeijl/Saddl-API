...
var order1 = new Order({origin: 'Rotterdam', destination: 'Spijkenisse', _packages: [package1._id, package2._id, package3._id], courier: courier1});
var order2 = new Order({origin: 'Rotterdam', destination: 'Spijkenisse', _packages: [package1._id, package2._id, package3._id], courier: courier2});
var order3 = new Order({origin: 'Rotterdam', destination: 'Spijkenisse', _packages: [package1._id, package2._id, package3._id], courier: courier3});
