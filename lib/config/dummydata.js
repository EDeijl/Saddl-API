...
var order2 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', destination: 'Lekkerkerk', _packages: package1._id});//_courier: courier2
var order3 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', destination: 'Arnhem', _packages: package1._id});//_courier: courier3
...
var user1 = new User({_id: new mongoose.Types.ObjectId(), provider: 'local', name: 'Test User', email: 'test@test.com', password: 'test', _orders: [order1]});
