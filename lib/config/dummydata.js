...
var order1 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', _courier: courier1, destination: 'Spijkenisse', _packages: package1._id, _user: user1});//_courier: courier1
var order2 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', _courier: courier1, destination: 'Spijkenisse', _packages: package1._id, _user: user1});//_courier: courier2
var order3 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', _courier: courier1, destination: 'Spijkenisse', _packages: package1._id, _user: user1});//_courier: courier3
