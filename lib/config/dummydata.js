...
var courier1 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Henk', picture: 'http://placehold.it/350x350', status: 'Beschikbaar', _specialties: [specialty1._id, specialty2._id], _transportation: transport1, location:{ longitude: 4.676185, latitude: 51.893643}}); //Groenezoom 1 Lekkerkerk
var courier2 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Harry', picture: 'http://placehold.it/350x350', status: 'Beschikbaar', _specialties: [specialty1._id, specialty2._id], _transportation: transport1, location:{ longitude: 4.484803, latitude: 51.917367}}); //Wijnhaven 99 Rotterdam
var courier3 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Harrold', picture: 'http://placehold.it/350x350', status: 'Beschikbaar', _specialties: [specialty1._id, specialty2._id], _transportation: transport1, location:{ longitude: 4.457619, latitude: 51.933792}}); //sourystraat 10, Rotterdam
var courier4 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Henk2', picture: 'http://placehold.it/350x350', status: 'Beschikbaar', _specialties: [specialty1._id, specialty2._id], _transportation: transport1, location:{ longitude: 4.480246, latitude: 51.928294}}); //Heer Bokelweg 155, Rotterdam(SADDL)
...
var order1 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', destination: 'Spijkenisse', _packages: package1._id, _user: user1});//_courier: courier1
var order2 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', destination: 'Spijkenisse', _packages: package1._id, _user: user1});//_courier: courier2
var order3 = new Order({_id : new mongoose.Types.ObjectId(), origin: 'Rotterdam', destination: 'Spijkenisse', _packages: package1._id, _user: user1});//_courier: courier3
