...
var courier1 = new Courier({_id : new mongoose.Types.ObjectId(), name: 'Henk', picture: 'http://placehold.it/350x350', status: 'Beschikbaar', _specialties: [specialty1._id, specialty2._id]});
